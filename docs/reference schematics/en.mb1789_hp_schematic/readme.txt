...
* @version 1.0
* @date      04-April-2022 
* @brief      Reference_Design_STM32WL_QFN48_4L_DirectTie_HighPower board manufacturing files package
******************************************************************************
...
========================
	...
	Manufacturing files and differents BOM variants for the board MB1789-HP
